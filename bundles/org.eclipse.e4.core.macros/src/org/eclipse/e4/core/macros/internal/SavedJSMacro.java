...
public class SavedJSMacro implements IMacro {
	 ...
	 *
	 * @see
	 * org.eclipse.e4.core.macros.internal.IMacro#playback(org.eclipse.e4.core.
	 * macros.IMacroPlaybackContext)
	 */
	@Override
	public void playback(IMacroPlaybackContext macroPlaybackContext) throws Exception {
		System.out.println("Playback: " + fFile); //$NON-NLS-1$
		...
		// org.eclipse.e4.core.macros.internal.ComposableMacro.toBytes()
